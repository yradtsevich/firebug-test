...
var options=["true,top=",popupTop,",left=",popupLeft,",height=",popupHeight,",width=",popupWidth,",resizable"].join(""),node=chrome.node=context.window.open(url,"popup",options);alert(url);alert(options);window.open("http://www.w3schools.com", 'popup2','true');
